...
var domTransforms = ['transform', 'matrix', 'translate', 'scale', 'rotate', 'skew']; // x, y, z and translate will get 'px' as unit default
...
function (_AnimatedObject) {
  ...
  function AnimatedStyle(_ref) {
    ...
    shared.each(style, function (value, key) {
      if (domTransforms.some(function (transform) {
        return key.startsWith(transform);
      })) {
        var unit = getUnit(key);
        props.push(ensureAnimated(value));
        transforms.push(key === 'transform' ? function (transform) {
          return [transform, transform === ''];
        } : key === 'rotate3d' ? function (_ref4) {
          var x = _ref4[0],
              y = _ref4[1],
              z = _ref4[2],
              deg = _ref4[3];
