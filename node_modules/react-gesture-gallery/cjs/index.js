...
var GestureView = _interopDefault(require('react-gesture-view'));

var ArrowRight = function () { return (React.createElement("svg", { style: {
        marginLeft: "2px",
        marginTop: "2px"
...
var ArrowLeft = function () { return (React.createElement("svg", { style: {
        marginRight: "2px",
        marginTop: "2px"
    }, width: "30", height: "30", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" },
    React.createElement("polyline", { points: "15 18 9 12 15 6" }))); };

function Indicators(_a) {
    var count = _a.count, index = _a.index, visible = _a.visible;
    return (React.createElement("div", { className: "Gallery__Indicators", style: {
            display: "flex",
        ...
        } }, Array.from(new Array(count)).map(function (_v, i) {
